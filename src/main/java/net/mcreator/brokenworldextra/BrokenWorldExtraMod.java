package net.mcreator.brokenworldextra;
...
@Mod("broken_world_extra")
public class BrokenWorldExtraMod {
	public static final Logger LOGGER = LogManager.getLogger(BrokenWorldExtraMod.class);
	public static final String MODID = "broken_world_extra";

	public BrokenWorldExtraMod() {
